...
export default function Hinu() {
  ...
  return (
    ...
    <div className="btn">
      <button onClick={() => changetheme("black")}>डार्क</button>
      <button onClick={() => changetheme("white")}>लाईट</button>
      <button onClick={() => changetheme("pink")}>गुलाबी</button>
    </div>
